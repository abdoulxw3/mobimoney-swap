...
description: Shared vocabulary for hedera-harness recipes — the files, the v3
  defaults, the stages, and the blind/evaluate-checklist rule. Use when
  authoring or auditing a harness recipe, or when another skill needs the recipe
  vocabulary.
---
