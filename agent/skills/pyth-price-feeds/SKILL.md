...
description: >
  Pyth pull price feeds on Hedera. Use when integrating Pyth on Hedera (testnet
  296 / mainnet 295), fetching Hermes update payloads, paying updatePriceFeeds,
  calling getPriceNoOlderThan, checking confidence, or normalizing signed price
  + expo to 18 decimals.
---
