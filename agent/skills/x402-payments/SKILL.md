...
name: x402-payments
description: >
  x402 pay-per-use payments on Hedera. Use when gating HTTP resources behind
  native HBAR payments, wiring a self-hosted Hedera facilitator (verify/settle),
  building x402ResourceServer / ExactHederaScheme flows, or integrating
  WalletConnect payment retries (PAYMENT-REQUIRED → PAYMENT-SIGNATURE).
---
