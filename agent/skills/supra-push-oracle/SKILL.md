...
description: >
  Supra S-Value push oracle on Hedera. Use when reading getSvalue price feeds on
  Hedera (testnet 296 / mainnet 295), mapping pair IDs, converting millisecond
  timestamps to unix seconds, or quoting USDT pairs where USD is unavailable.
---
