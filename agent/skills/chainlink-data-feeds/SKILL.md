...
description: >
  Chainlink Data Feeds on Hedera. Use when reading AggregatorV3 price feeds on
  Hedera (testnet 296 / mainnet 295), calling latestRoundData, checking round
  completeness and staleness, or normalizing feed decimals. Not for Chainlink
  CCIP (cross-chain tokens).
---
