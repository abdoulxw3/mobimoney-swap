...
description: Audit an existing hedera-harness recipe for wiring and
  evaluate-checklist problems before a run. Use when the user wants a harness
  recipe reviewed before running it.
---
# Review Harness Spec
